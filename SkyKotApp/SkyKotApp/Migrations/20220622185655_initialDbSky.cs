        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Houses_ZipCodes_ZipCodeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserHouseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserHouses", x => x.UserHouseId);
                    table.ForeignKey(
                        name: "FK_UserHouses_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RenterRooms", x => x.RenterRoomId);
                    table.ForeignKey(
                        name: "FK_RenterRooms_AcademicYears_AcademicYearId",
                        column: x => x.AcademicYearId,
                        principalTable: "AcademicYears",
                        principalColumn: "AcademicYearId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RenterRooms_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RenterRooms_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomExpenses", x => x.RoomExpenseId);
                    table.ForeignKey(
                        name: "FK_RoomExpenses_Expences_ExpenceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoomSpecificationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoomId = table.Column<int>(type: "int", nullable: false),
                    SpecificationId = table.Column<int>(type: "int", nullable: false),
                    IsAvailAble = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomSpecifications", x => x.RoomSpecificationId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Houses_ZipCodeId",
                table: "Houses",
                column: "ZipCodeId");

            migrationBuilder.CreateIndex(
                name: "IX_RenterRooms_AcademicYearId",
                table: "RenterRooms",
                column: "AcademicYearId");

            migrationBuilder.CreateIndex(
                name: "IX_RenterRooms_Id",
                table: "RenterRooms",
                column: "Id");

            migrationBuilder.CreateIndex(
                name: "IX_RenterRooms_RoomId",
                table: "RenterRooms",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomExpenses_ExpenceId",
                table: "RoomExpenses",
                column: "ExpenceId");
